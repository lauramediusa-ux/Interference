...
<header class="site-header">
  <div class="wrap">
    <div class="logo"><a href="/"><svg viewBox="0 0 1300 150" role="img" aria-label="Interferences"><text x="0" y="128" font-family="Helvetica Now Display, Helvetica Neue, Helvetica, Arial, sans-serif" font-weight="900" font-size="150" fill="#111111">INTERFERENCES</text></svg></a></div>
  </div>
